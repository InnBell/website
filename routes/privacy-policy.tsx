  ...
  return (
    <main class="py-28 prose mx-4 md:mx-auto min-h-screen">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to InnBell, the software program
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Affinity Hospitality Solutions LLP, 314
            Ansal Majestic Tower, Vikaspuri, West Delhi, Delhi - 110018, India.
          </p>
        </li>
        <li>
          <p>
